    ...
    return Container(
      ...
      child: DropdownButtonFormField(
        ...
        onChanged: (value) {
          ...
          (value == '0')
              ? sharedPref.setString('serviceName', skills[0])
              : (value == '1')
                  ? sharedPref.setString('serviceName', skills[1])
                  : (value == '2')
                      ? sharedPref.setString('serviceName', skills[2])
                      : sharedPref.setString('serviceName', skills[3]);
        },
      ),
    );
  }
